...
- (IBAction)shareWe:(UIButton *)sender {
    NSString *kLinkURL = [NSString stringWithFormat:@"http://1.liwww.applinzi.com/myapp/html/invitation.html?token=%@",GLOBAL_TOKEN ? GLOBAL_TOKEN : @""];
...
- (IBAction)qqShareBtn:(UIButton *)sender {
    if ([[UMSocialManager defaultManager] isInstall:UMSocialPlatformType_QQ]) {
        ...
        shareObj.webpageUrl = [NSString stringWithFormat:@"http://1.liwww.applinzi.com/myapp/html/invitation.html?token=%@",GLOBAL_TOKEN ? GLOBAL_TOKEN : @""];
