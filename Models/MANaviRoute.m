...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.routeColor = [UIColor redColor];
        self.walkingColor = [UIColor redColor];
        self.railwayColor = [UIColor redColor];
        
        self.trafficColors = @[[UIColor redColor], [UIColor redColor], [UIColor redColor], [UIColor redColor]];
    }
